...
#   ./run_exp.sh -b code/LA_BCP_train.py --exp LA_test --labelnum 4
#   ./run_exp.sh code/test_ACDC.py --model unet --labelnum 7
# =============================================================================
