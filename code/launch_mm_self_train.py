#!/usr/bin/env python3
"""从已完成的 MM pre_train 启动 self_train (跳过 pre_train)"""
...
parser.add_argument('--exp', type=str, default='MM_BCP_CMC_NA_v2_s0.3_5_labeled_5_labeled')
...
# 清空旧 self_train log (有 header 但崩溃了)
import shutil
if os.path.exists(self_snapshot_path):
    shutil.rmtree(self_snapshot_path)
