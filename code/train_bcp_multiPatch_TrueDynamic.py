...
parser.add_argument('--exp', type=str, default='BCP_Multiscale_Dynamic_Patch', help='experiment_name')
    ...
    for _ in iterator:
        for _, sampled_batch in enumerate(trainloader):
            ...
            with torch.no_grad():
                ...
                # 动态权重：尺度越小，权重越低（保护 Student 不被噪声误导）
